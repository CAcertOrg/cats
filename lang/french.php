...
define("accept_Login_12","Inscription avec ce certificat?<br /><br />".
                         "Seul le numéro de série du certificat sera stocké. Vous devrez fournir le nom commun du certificat (\"Common Name\") si vous souhaitez obtenir un attestation imprimée après passage du test<br />".
...
define("Button_01","Créer une nouvelle matière");
...
define("certificateDocu_01","Si vous le souhaitez, nous pouvons vous fournir un document attestant que vous avez passé le test d'accréditeur. Le document sera émis à votre nom comme indiqué dans votre certifcat numérique.");
...
define("Class_Answer_07","Dans un texte à trous, les réponses correctes et incorrectes doivent être différents.");
...
define("Topic_01","Remarque: Vous ne pouvez pas déclarer des réponses comme correcte ici, alors qu'elles ont été déclarées incorrectes ci-dessous.");
