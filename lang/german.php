<?php
define("accept_Login_01","Sie sind noch nicht im System angemeldet. <br /> Bitte überprüfen Sie die Informationen Ihres Zertifikats und bestätigen Sie die Registrierung.");
define("accept_Login_02","Informationen Ihres Zertifikats");
define("accept_Login_03","Herausgegeben für:");
...
define("accept_Login_11","läuft ab am");
define("accept_Login_12","Mit diesen Informationen Registrieren?<br /><br />".
                         "Nur die Seriennummer ihres Zertifikats wird in der Datenbank gespeichert, aber wenn Sie nach einem bestandenen Test eine gedruckte Bestätigung anfordern wollen, muss diese Bestätigung auf den im Zertifikat enthaltenen Allgemeinen Namen ausgestellt werden!<br />".
                         "Für anonyme Zertifikate (Allgemeiner Name \"CAcert WoT User\") kann keine Bestätigung ausgestellt werden.");
define("accept_Login_13","Gültigkeit:");
define("Button_01","Neues Thema erstellen");
define("Button_02","Zurück zu den Themen");
define("Button_03","Zurück zu den Fragen");
...
define("Button_12","Änderungen speichern");
define("Button_13","Antworten editieren");
define("Button_14","Antwort hinzufügen");
...
define("Check_Cert_01","Wenn Sie eine Bestätigung per Email oder Post erhalten möchten, muss Ihr Name im Zertifikat enthalten sein! <br /> Sie können entweder mit der Registrieung fortfahren, allerdings haben Sie dann nicht die Möglichkeit die Bestätigung per E-Mail oder über den Postweg zu erhalten. <br />Sie können aber auch die Registrierung mit diesem Zertifikat abbrechen und sich mir einem anderen  Zertifikat anmelden, indem Ihr Name enthalten ist. ");
define("certificateDocu_01","Wenn Sie möchten senden wir Ihnen ein Bestätigung zu, dass Sie den Assurer Test erfolgreich abgeschlossen haben. Im Dokument wird Ihr Name, der im Zertifikat enthalten ist verwendet.");
define("certificateDocu_02","Nein, ich benötige keine Bestätigung");
define("certificateDocu_03","Ja, bitte senden Sie mir die Bestätigung als PDF-Attachement via eMail  (Wir verwenden die Email-Adresse, die in Ihrem Zertifikat enthalten ist.)");
define("certificateDocu_04","Ja, bitte senden sie mir die Bestätigung auf dem Postweg zu");
define("certificateDocu_05","Vorname");
define("certificateDocu_06","Nachname");
define("certificateDocu_07","Straße");
...
define("certificateDocu_12","Alle Felder müssen ausgefüllt sein, wenn sie über den Postweg Ihre Beglaubigung erhalten möchten.S");
define("Class_Answer_01","Details der Antworten");
define("Class_Answer_02","Antworten");
define("Class_Answer_03","Antwort");
define("Class_Answer_04","In zu wenigen Antworten befindet sich Inhalt, es müssen immer mindestens 2 Antworten  ausgefüllt sein.");
...
define("Class_Answer_07","Bei Lückentext dürfen die falschen Antworten nicht wie die richtigen lauten");
...
define("Class_Progress_02","Es sind zu viele Daten zu diesem Thema in der Datenbank enthalten.  "); // gehört zu Lernfortschritte_angezeigt
...
define("Class_Question_01","Klicken Sie hier um nähere Informationen über diese Frage zu erhalten");
define("Class_Question_02","Setzen Sie die Frage inaktiv");
define("Class_Question_03","Setzen Sie die Frage aktiv");
define("Class_Question_04","Löschen Sie die Frage");
define("Class_Question_05","Keine Fragen in der Datenbank vorhanden");
define("Class_Question_06","Details der Frage");
define("Class_Quiz_01","Es gibt nicht genug Fragen zu diesem Thema bitte wählen sie ein anderes Thema aus");
...
define("Class_Topic_08","Löschen Sie das Thema und alle dazugehörien Fragen und Antworten");
define("Class_Topic_09","min. Prozentzahl muss eine Zahl sein und darf nicht größer als 100 sein");
...
define("Collect_Question_02","Mindestens eine Lücke muss definiert sein. Lücken werden mittels [ ] erstellt. In der Lücken muss sich die richtige Antwort befinden. Alle Lücken müssen wieder geschlossen werden. ");
define("Collect_Question_03","enter question");
define("Function_getContent_01","Willkommen");
define("Function_getContent_02_Intro",'<div class="centered">Eine kurze Einführung gibts <a href="http://wiki.cacert.org/wiki/AssurerChallenge" rel="external">im WiKi</a></div><br />');
...
define("Function_reallyDel_01","Löschvorgang");
define("Function_reallyDel_02","Möchten Sie das Thema wirklich löschen?");
define("Function_reallyDel_03","Alle Fragen und Antworten werden ebenfalls gelöscht, wenn Sie bestätigen.");
define("Function_reallyDel_04","Möchten Sie die Frage wirklich löschen?");
define("Get_Content_01","Registrierung wurde abgebrochen! ");
define("Global_01","Sie müssen eingeloggt sein um diese Funktionen nutzen zu können");
define("Global_02","zurück");
...
define("Global_17","Loginvorgang fehlgeschlagen ! Es wird ein gültiges Zertifikat von CAcert benötigt.");
...
define("Statistic_20","Info über Tests");
define("Statistic_21","Datum");
define("Statistic_22","durchgeführte Tests");
define("Statistic_23","davon bestanden");
define("Statistic_24","Französisch");
...
define("Topic_01","Achtung:Sie können keine Antworten als richtig deklarieren, die unten als falsch deklariert wurden");
define("Topic_02","Themen Übersicht");
